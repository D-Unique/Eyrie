    ...
    <>
      <div className="bg-[#FEFEFE] min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 grid grid-cols-1 lg:grid-cols-6 gap-4 sm:gap-8">
          ...
          {/* Profile Details */}
          <main className="col-span-1 lg:col-span-4 bg-[#FEFEFE] shadow-md rounded-[32px] p-4 sm:p-6 md:p-8">
            <h1 className="lg:text-xl text-base text-[#161616] font-bold mb-2 sm:mb-4">
              Welcome, <span className="text-[#555]">Sarah</span>
            </h1>
            <h2 className="text-[#161616] font-bold mb-4 sm:mb-6 text-xl lg:text-3xl">
              Edit Profile
            </h2>
                ...
                <div className="flex flex-col justify-center w-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-x-12">
                    <div className="mb-1 sm:mb-0">
                      <p className="text-xs sm:text-sm font-medium text-[#555]">
                        Full Name
                      </p>
                      <p className="font-medium text-xs sm:text-sm text-[#161616] truncate">
                        Sarah Young
                      </p>
                    </div>
                    <div className="mb-1 sm:mb-0">
            ...
            <section className="mb-6 sm:mb-10">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <button className="text-xs sm:text-sm text-[#555] hover:underline">
                  Cancel
                </button>
              </div>
            ...
            <section>
              ...
              <div className="border border-gray-300 rounded-xl p-3 sm:p-4 bg-gray-50 text-xs sm:text-sm text-gray-800 leading-relaxed h-40 sm:h-60 overflow-y-auto custom-scrollbar">
                As a passionate real estate enthusiast based in Lagos, I
                specialize in connecting buyers and sellers with their dream
                properties. With over five years of experience in the real
                estate market, I have a deep understanding of local
                neighborhoods and market trends, allowing me to provide valuable
                insights to my clients.
                <br />
                <br />
                <strong>What I Offer:</strong>
                <br />
                • Buyer Representation: Helping first-time buyers navigate the
                complexities of the real estate market with ease.
                <br />
                • Seller Services: Assisting homeowners in effectively marketing
                and selling their properties.
                <br />
                • Property Management: Offering management services to ensure
                your investment is well taken care of.
                <br />
                • Guided Tours: Personalized property tours to showcase the best
                listings that fit your needs.
                <br />
                <br />
                <strong>Why Choose Me?</strong>
                <br />I pride myself on my integrity, dedication, and the
                personalized approach I bring to each transaction.
              </div>
            </section>
          </main>
          ...
          <aside className="col-span-1 lg:col-span-1 bg-white shadow-md rounded-2xl p-4 sm:p-6 max-h-[400px]">
            <h3 className="text-sm sm:text-sm font-semibold text-[#161616] mb-4">
