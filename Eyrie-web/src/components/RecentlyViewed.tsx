...
// Sample recently viewed listings - in a real app, this would come from user browsing history
const recentlyViewedListings = listings.slice(0, 4); // Taking first 4 listings as examples
